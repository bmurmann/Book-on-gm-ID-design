...
c.modelfile = '../hspice/ee214b_hspice.sp';
c.modelinfo = 'Stanford EE214B models, 180nm CMOS, BSIM3v3';
c.corner = 'NOM';
c.temp = 300;
c.modeln = 'nch';
c.modelp = 'pch';
c.savefilen = '180nch';
c.savefilep = '180pch';
c.simcmd = '/usr/class/ee/synopsys/hspice/I-2013.12-SP2/hspice/bin/hspice techsweep.sp >! techsweep.out';
...
'.probe dc n_cgg  = par(''cggbo(mn)'') \n'...
'.probe dc n_cgs  = par(''-cgsbo(mn)'') \n'...
'.probe dc n_cgd  = par(''-cgdbo(mn)'') \n'...
'.probe dc n_cgb  = par(''cggbo(mn)-(-cgsbo(mn))-(-cgdbo(mn)) '') \n'...
'.probe dc n_cdd  = par(''cddbo(mn)'') \n'...
'.probe dc n_css  = par(''-cgsbo(mn)-cbsbo(mn)'') \n'...
'\n'...
...
'.probe dc p_cgg  = par(''cggbo(mp)'') \n'...
'.probe dc p_cgs  = par(''-cgsbo(mp)'') \n'...
'.probe dc p_cgd  = par(''-cgdbo(mp)'') \n'...
'.probe dc p_cgb  = par(''cggbo(mp)-(-cgsbo(mp))-(-cgdbo(mp)) '') \n'...
'.probe dc p_cdd  = par(''cddbo(mp)'') \n'...
'.probe dc p_css  = par(''-cgsbo(mp)-cbsbo(mp)'') \n'...
'.end \n'...
